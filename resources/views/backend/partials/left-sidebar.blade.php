<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="{{ asset('admin/dashboard') }}"><img class="main-logo size-logo" src="img/logo/logo.png" alt="" /></a>
        ...
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        <a class="has-arrow" href="{{ asset('admin/contact') }}" aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow" href="{{ asset('admin/bill') }}" aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow" href="{{ asset('admin/statistic') }}" aria-expanded="false">
