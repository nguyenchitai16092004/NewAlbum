                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="product-payment-inner-st">
                            <!-- Add Product Form -->
                            <form action="{{Route('Add_Product')}}" method="POST" enctype="multipart/form-data" class="dropzone dropzone-custom">
                                @csrf
                                <div class="row">
                                    <!-- Left Column -->
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="MaNhomNhacCaSi" id="MaNhomNhacCaSi" class="form-control">
                                                @foreach ($Band as $item)
                                                    <option value="{{ $item->MaNhomNhacCaSi }}">{{ $item->TenNhomNhacCaSi }}</option>
                                                @endforeach
                                            </select>
                                        </div>
