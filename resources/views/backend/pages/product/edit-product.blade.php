                ...
                <div class="row">   
                    <div class="col-lg-12">
                        <div class="product-payment-inner-st">
                            <!-- Edit Product Form -->
                            <form action="{{ route('Edit_Product', ['id' => $products->MaSP]) }}" method="POST" enctype="multipart/form-data" class="dropzone dropzone-custom">
                                @csrf
                                <div class="row">
                                    <!-- Left Column -->
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="SoLuong" type="number" class="form-control" value="{{ $products->SoLuong }}" placeholder="Quantity">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="MaNhomNhacCaSi" id="MaNhomNhacCaSi" class="form-control">
                                                @foreach ($Band as $item)
                                                    <option value="{{ $item->MaNhomNhacCaSi }}" {{ $products->MaNhomNhacCaSi == $item->MaNhomNhacCaSi ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="MaLoaiSP" id="MaLoaiSP" class="form-control">
                                                @foreach ($Category as $item)
                                                    <option value="{{ $item->MaLoaiSP }}" {{ $products->MaLoaiSP == $item->MaLoaiSP ? 'selected' : '' }}>
                                                        {{ $item->TenLoaiSP }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <img src="{{ asset('Storage/SanPham/' . $products->HinhAnh) }}" style="width: 100px; height:100px">
                                    </div>
                                </div>
