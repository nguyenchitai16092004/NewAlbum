...
@section('main')
    ...
    <div class="all-content-wrapper" style="margin: 10px">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input name="gia_nhap" type="number"
                                                                                    class="form-control"
                                                                                    placeholder="import price">
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="">Selling Price</label>
                                                                                <input name="gia_ban" type="number"
                                                                                    class="form-control"
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input name="so_luong" type="number"
                                                                                    class="form-control"
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="LoaiHang"
                                                                                    ...
                                                                                    <option value="1">Pre-Oder
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="MaNhomNhacCaSi">Nhóm nhạc/Ca
                                                                                    sĩ:</label>
                                                                                <select name="MaNhomNhacCaSi"
                                                                                    id="MaNhomNhacCaSi"
                                                                                    class="form-control">
                                                                                    <option value="" selected
                                                                                        disabled>Chọn nhóm nhạc/ca sĩ
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="form-group">
